...
class S {
  ...
  String get ForgotPasswordMassage {
    return Intl.message(
      'Enter your email and we will send you a reset link',
  ...
  /// `Order and receive anytime`
  String get loremTitle3 {
    return Intl.message(
      'Order and receive anytime',
      name: 'loremTitle3',
      desc: '',
  ...
  String get logInToYourExistingAccount {
    return Intl.message(
      'Log in to your existing account',
      name: 'logInToYourExistingAccount',
      desc: '',
      args: [],
    );
  }
